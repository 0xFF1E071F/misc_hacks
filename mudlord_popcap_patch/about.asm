...
.data
String	db ' The RED Crew',0Ah
		db 'proudly presents',0Ah
		db 0Ah
		db 'PopCap Games All Games *Patch* v1.00',0Ah
		db 'Protection: PopCap DRM Protect',0Ah
		db 0Ah
		db 'Cracked/coded by mudlord/RED',0Ah
		db 'Graphics by mKs',0Ah
		db 'msx: crocoprinter.....',0Ah
		db 0Ah
		db 'My greetz fly out to:',0Ah
		db 0Ah
		db 'BytePlayer',0Ah
		db 'mKs',0Ah
		db 'Xylitol',0Ah
		db 'Xspider',0Ah
		db 'Binary',0Ah
		db 'and the people I forgot :P',0Ah
		db 0Ah
		db 'Group greetz fly out to:',0Ah
		db 0Ah
		db 'ARTeam',0Ah
		db 'SnD',0Ah
		db 'TSRh',0Ah
		db '{RES}',0Ah
		db 'CiM',0Ah
		db 'And all the other decent groups in the scene!',0Ah
		db 'Not to mention the decent independants ;)',0Ah
		db 0Ah
		db 0Ah
		db 'Fuck offs to cocksuckers like WRATH, CU,',0Ah
		db 'and other douchebags!',0Ah
		db 0Ah
		db 'May you rippers rot in hell!',0Ah
		db 0Ah,0
